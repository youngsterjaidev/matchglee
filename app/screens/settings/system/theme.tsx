...
const THEME_OPTIONS: RadioOption[] = [
  ...
  { value: 'custom', label: 'Customize Your Theme' },
];

const ThemeScreen: React.FC = () => {
  const router = useRouter();
  const [themeMode, setThemeMode] = useState('dark');
  const [festiveTheme, setFestiveTheme] = useState(false);
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <CardContainer>
          <RadioCardGroup options={THEME_OPTIONS} selectedValue={themeMode} onSelect={setThemeMode} embedded />
        </CardContainer>
        ...
        <CardContainer withDividers>
          <ToggleRow
            ...
            title="Festive Theme"
            subtitle="Apply seasonal accents and decorative visuals"
            value={festiveTheme}
            onValueChange={setFestiveTheme}
          />
        </CardContainer>
